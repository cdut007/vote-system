 ...
 * =============================================================================
 */
package com.itender.ms.bank.unionpay.acp.sdk;
...
public class SDKConfig {
	...
	public static final String FILE_NAME = "prod_acp_sdk.properties";
	//public static final String FILE_NAME = "test_acp_sdk.properties";
	/** 前台请求URL. */
	...
	private String frontResponseUrl;
	...
	/** 配置文件中的前台URL常量. */
	public static final String SDK_FRONT_RESPONSE_URL = "acpsdk.frontResponseUrl";
	/** 配置文件中的后台URL常量. */
	public static final String SDK_BACK_RESPONSE_URL = "acpsdk.backResponseUrl";
	/**商铺编号**/
	public static final String SDK_MER_ID="merId";
	...
	public void loadProperties(Properties pro) {
		...
		value=pro.getProperty(SDK_FRONT_RESPONSE_URL);
		if (!SDKUtil.isEmpty(value)) {
			this.frontResponseUrl = value.trim();
		}
		value=pro.getProperty(SDK_BACK_RESPONSE_URL);
		if (!SDKUtil.isEmpty(value)) {
			this.backResponseUrl = value.trim();
		}
	...
	public String getFrontResponseUrl() {
		return frontResponseUrl;
	}

	public void setFrontResponseUrl(String frontResponseUrl) {
		this.frontResponseUrl = frontResponseUrl;
	}

	public String getBackResponseUrl() {
		return backResponseUrl;
	}

	public void setBackResponseUrl(String backResponseUrl) {
		this.backResponseUrl = backResponseUrl;
	}
