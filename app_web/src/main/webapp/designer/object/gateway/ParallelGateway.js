draw2d.ParallelGateway = function(configPropCallback, _url) {
...
draw2d.ParallelGateway.prototype.onDoubleClick = function() {
	if (typeof this.openPropertiesCallBack == "function") {
		this.openPropertiesCallBack(this);
	}
};

draw2d.ParallelGateway.prototype.getListener = function(id) {
...
draw2d.ParallelGateway.prototype.deleteListener = function(id) {
	var listener = this.getListener(id);
	this.listeners.remove(listener);
};
draw2d.ParallelGateway.prototype.addListener = function(listener) {
	this.listeners.add(listener);
};
draw2d.ParallelGateway.prototype.setListeners = function(listeners) {
	this.listeners = listeners;
};
draw2d.ParallelGateway.prototype.getListenersXML = function() {
	var xml = '';
	for (var i = 0; i < this.listeners.getSize(); i++) {
		var listener = this.listeners.get(i);
...
draw2d.ParallelGateway.prototype.getExtensionElementsXML = function() {
...
draw2d.ParallelGateway.prototype.getDocumentationXML = function() {
