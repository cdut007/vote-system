draw2d.ExclusiveGateway = function(configPropCallback, _url) {
...
draw2d.ExclusiveGateway.prototype.onDoubleClick = function() {
	if (typeof this.openPropertiesCallBack == "function") {
		this.openPropertiesCallBack(this);
	}
};

draw2d.ExclusiveGateway.prototype.getListener = function(id) {
...
draw2d.ExclusiveGateway.prototype.deleteListener = function(id) {
	var listener = this.getListener(id);
	this.listeners.remove(listener);
};
draw2d.ExclusiveGateway.prototype.addListener = function(listener) {
	this.listeners.add(listener);
};
draw2d.End.prototype.setListeners = function(listeners) {
	this.listeners = listeners;
};
draw2d.ExclusiveGateway.prototype.getListenersXML = function() {
	var xml = '';
	for (var i = 0; i < this.listeners.getSize(); i++) {
		var listener = this.listeners.get(i);
...
draw2d.ExclusiveGateway.prototype.getExtensionElementsXML = function() {
...
draw2d.ExclusiveGateway.prototype.getDocumentationXML = function() {
