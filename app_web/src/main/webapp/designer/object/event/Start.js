draw2d.Start = function(configPropCallback, _url) {
...
draw2d.Start.prototype.generateId = function() {
	this.id = "startevent" + Sequence.create();
...
draw2d.Start.prototype.toXML = function() {
	...
	if (this.initiator != null && this.initiator != "") {
		xml += 'activiti:initiator="' + this.initiator + '" ';
	}
...
draw2d.Start.prototype.getListener = function(id) {
...
draw2d.Start.prototype.deleteListener = function(id) {
	var listener = this.getListener(id);
	this.listeners.remove(listener);
};
draw2d.Start.prototype.addListener = function(listener) {
	this.listeners.add(listener);
};
draw2d.Start.prototype.setListeners = function(listeners) {
	this.listeners = listeners;
};
draw2d.Start.prototype.getListenersXML = function() {
	var xml = '';
	for (var i = 0; i < this.listeners.getSize(); i++) {
		var listener = this.listeners.get(i);
...
draw2d.Start.prototype.getFormProperties = function(id) {
...
draw2d.Start.prototype.deleteFormProperties = function(id) {
	var prop = this.getFormProperties(id);
	this.formProperties.remove(prop);
};
draw2d.Start.prototype.addFormProperties = function(prop) {
	this.formProperties.add(prop);
};
draw2d.Start.prototype.setFormProperties = function(props) {
	this.formProperties = props;
};
draw2d.Start.prototype.getFormPropertiesXML = function() {
	var xml = '';
	for (var i = 0; i < this.formProperties.getSize(); i++) {
...
draw2d.Start.prototype.getExtensionElementsXML = function() {
	if (this.listeners.getSize() == 0 && this.formProperties.getSize() == 0)
		return '';
	var xml = '<extensionElements>\n';
	xml += this.getFormPropertiesXML();
	xml += this.getListenersXML();
	xml = xml + '</extensionElements>\n';
	return xml;
};
draw2d.Start.prototype.getDocumentationXML = function() {
