...
draw2d.MailTask.prototype.getExtensionElementsXML = function() {
	if (this.listeners.getSize() == 0 && (this.to == null || this.to == '') && (this.from == null || this.from == '') && (this.subject == null || this.subject == '') && (this.cc == null || this.cc == '') && (this.bcc == null || this.bcc == '') && (this._charset == null || this._charset == '') && (this._text == null || this._text == '') && (this._html == null || this._html == ''))
		return '';
...
draw2d.MailTask.prototype.getFieldsXML = function() {
	...
	if (this.to != null && this.to != '') {
		...
		if (/\$\{.+\}/.test(this.to)) {
			xml = xml + '<activiti:expression>' + this.to + '</activiti:expression>';
		} else {
			xml = xml + '<activiti:string><![CDATA[' + this.to + ']]></activiti:string>\n';
		}
	...
	if (this.from != null && this.from != '') {
		...
		if (/\$\{.+\}/.test(this.from)) {
			xml = xml + '<activiti:expression>' + this.from + '</activiti:expression>';
		} else {
			xml = xml + '<activiti:string><![CDATA[' + this.from + ']]></activiti:string>\n';
		}
		xml = xml + '</activiti:field>\n';
	}
	if (this.subject != null && this.subject != '') {
		xml = xml + '<activiti:field name="subject" >\n';
		if (/\$\{.+\}/.test(this.subject)) {
			xml = xml + '<activiti:expression>' + this.subject + '</activiti:expression>\n';
		} else {
			xml = xml + '<activiti:string><![CDATA[' + this.subject + ']]></activiti:string>\n';
		}
		xml = xml + '</activiti:field>\n';
	}
	if (this.cc != null && this.cc != '') {
		...
		if (/\$\{.+\}/.test(this.cc)) {
			xml = xml + '<activiti:expression>' + this.cc + '</activiti:expression>\n';
		} else {
			xml = xml + '<activiti:string><![CDATA[' + this.cc + ']]></activiti:string>\n';
		}
		xml = xml + '</activiti:field>\n';
	}
	if (this.bcc != null && this.bcc != '') {
		...
		if (/\$\{.+\}/.test(this.bcc)) {
			xml = xml + '<activiti:expression>' + this.bcc + '</activiti:expression>\n';
		} else {
			xml = xml + '<activiti:string><![CDATA[' + this.bcc + ']]></activiti:string>\n';
		}
		xml = xml + '</activiti:field>\n';
	}
	if (this._charset != null && this._charset != '') {
		xml = xml + '<activiti:field name="charset">\n';
		if (/\$\{.+\}/.test(this._charset)) {
			xml = xml + '<activiti:expression>' + this._charset + '</activiti:expression>\n';
		} else {
			xml = xml + '<activiti:string><![CDATA[' + this._charset + ']]></activiti:string>\n';
		}
		xml = xml + '</activiti:field>\n';
	}
	if (this._html != null && this._html != '') {
		...
		if (/\$\{.+\}/.test(this._html)) {
			xml = xml + '<activiti:expression>' + this._html + '</activiti:expression>\n';
		} else {
			xml = xml + '<activiti:string><![CDATA[' + this._html + ']]></activiti:string>\n';
		}
		xml = xml + '</activiti:field>\n';
	}
	if (this._text != null && this._text != '') {
		...
		if (/\$\{.+\}/.test(this._text)) {
			xml = xml + '<activiti:expression>' + this._text + '</activiti:expression>\n';
		} else {
			xml = xml + '<activiti:string><![CDATA[' + this._text + ']]></activiti:string>\n';
		}
		xml = xml + '</activiti:field>\n';
	}
	return xml;
