...
(function(window, undefined) {
	...
	var _SINGLE_TAG_MAP = _toMap('area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed');
	var _STYLE_TAG_MAP = _toMap('b,basefont,big,del,em,font,i,s,small,span,strike,strong,sub,sup,u');
	var _CONTROL_TAG_MAP = _toMap('img,table,input,textarea,button');
	var _PRE_TAG_MAP = _toMap('pre,style,script');
	var _NOSPLIT_TAG_MAP = _toMap('html,head,body,td,tr,table,ol,ul,li');
	var _AUTOCLOSE_TAG_MAP = _toMap('colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr');
	var _FILL_ATTR_MAP = _toMap('checked,compact,declare,defer,disabled,ismap,multiple,nohref,noresize,noshade,nowrap,readonly,selected');
	var _VALUE_TAG_MAP = _toMap('input,button,textarea,select');
	//获取根应用名
