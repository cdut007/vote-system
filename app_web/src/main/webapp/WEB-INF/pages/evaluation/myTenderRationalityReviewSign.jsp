...
<c:set value="${qualificationResultDetailService.tenderRationalityReview2pdf(expertApplyId,projectItemId,'','','','')}" var="attachmentId" />
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#pass").click(function() {
	            ...
	            var paramsArray = {"expertApplyId":"${expertApplyId}","projectItemId":"${projectItemId}"};
                var returnValue = SaveDocArray(paramsArray,"${pageScope.basePath}/evaluation/tenderRationalityArchive");
	            if ("OK" == returnValue) {
	                $("#workflowForm").submit();
	                ShowMessage("操作成功！");
	            } else {
