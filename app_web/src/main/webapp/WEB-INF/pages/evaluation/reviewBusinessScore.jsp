...
%>
<c:set value="${tenderItemScoreService.listAllTenderItemScore2Pdf(processBusinessKey,projectItemId,'','','')}" var="attachmentId" />

<!DOCTYPE HTML>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>商务部分评分合议</title>
	...
	<div class="block">
		...
		<div class="usBox">
			<div style="text-align: center;">
				<font style="font-size: 14pt; font-weight: bold;">${projectInstance}详细评审结果合议</font>
			</div>
