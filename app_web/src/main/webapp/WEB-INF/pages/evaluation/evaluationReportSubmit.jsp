...
<script type="text/javascript">
	$(function() {
		...
		$("#sub").click(function(){
			...
			if(r==1){
                var paramsArray = {"taskId":"${taskId}", "expertApplyId":"${processBusinessKey}","pass":"true"};
...
<body>
	...
	<div style="border-radius: 5px;border:#e4e4e4 1px solid;padding:5px;bottom:0px;height:30px;background-color:#eeeeff;z-index:9999;right:5px;left:5px;">
		<form:form action="${pageContext.request.contextPath}/evaluation/completeFormEvaluationReportSign" method="post" modelAttribute="">
