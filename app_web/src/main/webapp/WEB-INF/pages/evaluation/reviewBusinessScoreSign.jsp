...
%>
<c:set value="${tenderItemScoreService.listReviewQualificationResultDetailList2pdf(processBusinessKey,projectItemId)}" var="attachmentId" />
<c:set value="${userService.retrieveExpertSign(processBusinessKey)}" var="expertList" />
<c:set value="${expertApplyService.getExpertSealSignList(processBusinessKey,projectItemId,'','FIRST_DETAIL','')}" var="expertSignList" />
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#agree").click(function() {
            ...
            var returnValue = SaveDocArray(paramsArray,"${pageScope.basePath}/evaluation/expertDetailReviewSign2");
            if ("OK" == returnValue) {
                $("#workflowForm").submit();
                ShowMessage("操作成功！");
            } else {
