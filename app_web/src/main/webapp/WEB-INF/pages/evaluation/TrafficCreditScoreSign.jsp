...
%>
<c:set value="${tenderItemService.creditScoringPdf(processBusinessKey,projectItemId)}" var="pdfId" />
<c:set value="${userService.retrieveExpertSign(processBusinessKey)}" var="expertList" />
<c:set value="${expertApplyService.getExpertSealSignList(processBusinessKey,projectItemId,'TRAFFIC_CREDIT')}" var="expertSignList" />
...
<script type="text/javascript">
	...
	function HWPostil1_NotifyCtrlReady() {
	    ...
	    OpenFile("${pageScope.basePath}/attachment/download/${pdfId}");
	}
	...
	$(function() {
		...
		$("#agree").click(function() {
			...
			var paramsArray = {"expertApplyId":"${processBusinessKey}","reviewType":"TRAFFIC_CREDIT","projectItemId":"${projectItemId}"};
