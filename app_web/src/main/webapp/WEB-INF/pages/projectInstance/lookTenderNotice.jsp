...
.black_overlay {
	...
	<script type="text/javascript">
		$(function() {
			sealUtil.loadAllSealWithBKey("${tenderNotice.id}","data=string2sign","sealPos");
...
<body>
	...
	<div class="block ">
		<div id="ur_here">
			...
			<code>&gt;</code>
			查看招标公告 <input type="button" id="btnPrint" value="打印" />
		</div>
		<div class="blank10"></div>
		<div id="printContent">
			<div class="usBox main" id="ht_content">
				<div id="printNR">${tenderNotice.ggnrwb}</div>
			...
			<%-- <c:choose>
				...
				<c:otherwise>
					<iframe
						...
						style="border:1px solid #ddd;height:800px;width:100%;"><span id="sealPos"></span></iframe>
				</c:otherwise>
			</c:choose> --%>
		</div>
	</div>
