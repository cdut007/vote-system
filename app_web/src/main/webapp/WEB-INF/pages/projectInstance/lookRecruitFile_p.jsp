...
.black_overlay {
	...
	<script type="text/javascript">
		$(function() {
			sealUtil.loadAllSealWithBKey("${recruitFile.id}","data=string2sign","sealPos");
...
<body>
	...
	<div class="block ">
		<div id="ur_here">
			...
			<code>&gt;</code>
			查看招标文件 <input type="button" id="btnPrint" value="打印" />
		</div>
		<div class="blank10"></div>
		<div id="printContent">
			<%-- <div class="usBox main" id="ht_content">
				<div id="printNR">${recruitFile.wordAttachment.fjnr00}</div>
