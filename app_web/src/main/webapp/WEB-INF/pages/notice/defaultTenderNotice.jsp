...
<p><br /></p>
	...
	<h2>六、开标时间及地点</h2>
	<p style="text-indent:0em;">
		<span>1、</span>开标时间：<span class="need_input u" name="tenderNoticeData.bidOpenDate"><fmt:formatDate value="${tenderNoticeData.bidOpenDate}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
	</p>
	<p style="text-indent:0em;">
		<span>2、</span>开标地点：<span class="need_input u" name="tenderNoticeData.bidOpenPlace">${tenderNoticeData.bidOpenPlace}</span>
	</p>
	<p><br /></p>
