...
<div class="usBox">
 <div class="clearfix">
<form:form method="post" action="${pageContext.request.contextPath}/aptitude/auditAptitude" commandName="aptitude">
	<form:hidden path="id" />
	...
	<table width="100%" style="table-layout:fixed;">
		...
		<tr  valign="top">
			<td class="need">*</td>
			<td>资质附件：</td>
			<td><div id="aptitudediv" style="display: none;">
		    ...
		    <td class="need"></td>
			<td>回退原因：</td>
			<td><form:textarea path="backReason" id="backReason" rows="4" cols="50"/></td>
		</tr>
