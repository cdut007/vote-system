...
<script type="text/javascript" src="/resources/page/base/aptitude/aptitudeOwnList.js"></script>
</head>
<body>
	...
	<div class="block">
		...
		<div class="usBox">
			...
			<a class="button red" href="/aptitude/addAptitudeModel">添加资质</a>
			<a class="button red" onclick="selectDetailed();">资质详情</a>
			<a class="button red" onclick="editAptitude();">资质编辑</a> 
			<a class="button red" onclick="delAptitudes();">资质删除</a> 
