...
<div class="easyui-layout" data-options="fit:true" style="width:800px;height:560px;">
	<div data-options="region:'center',border:false" style="padding:2px;">
		<table id="adddepartmentuser-datagrid" class="easyui-datagrid" data-options="toolbar:'#addusertoolbar',url:'${pageContext.request.contextPath}/user/pagingUserData',rownumbers:true,border:true,pagination:true,fit:true,idField: 'id',striped:true,pageSize:20,queryParams:{notDepartmentId:'${notDepartmentId}'}">
			<thead>
				<tr>
