...
%>
<c:set value="${bidFileService.reviseAttachmentPdfId(processBusinessKey,projectItemId)}" var="attachmentId" />
<c:set value="${userService.retrieveExpertSign(processBusinessKey)}" var="expertList" />
<c:set value="${expertApplyService.getExpertSealSignList(processBusinessKey,projectItemId,'','REVISE',reviewType)}" var="expertSignList" />

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>算术性错误修正表确认</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#agree").click(function() {
            ...
            var returnValue = SaveDocArray(paramsArray,"${pageScope.basePath}/bidFile/expertReviseAttachmentConfirmSign");
            if ("OK" == returnValue) {
                $("#workflowForm").submit();
                ShowMessage("操作成功！");
            } else {
		...
		<div class="usBox">
			...
			<%-- <div id="disagreeDiv" >
				...
				<%if(signStatus==0){%>
				 	...
				 	<input type="button" class="button red" value="提交下一步" id="agree" />
				<%}%>
