					...
					<td colspan="4">
						<div id="aptitudediv" style="display: none;">
							<c:forEach items="${aptitude.attachmentList}" var="fileItem" varStatus="s">
								<img style="width:150px;height:80px; border:1px solid #D1D1D1" src="${pageContext.request.contextPath}/common/showpic?id=${fileItem.fjid00}" id="aptitudeImg" />
							</c:forEach>
						</div>
						<br />
					</td>
