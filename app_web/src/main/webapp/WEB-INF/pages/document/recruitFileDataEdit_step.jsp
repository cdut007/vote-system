...
<body>
	...
	<div class="block">
		<form:form id="zbwjForm" method="post" action="${pageContext.request.contextPath}/flow/completeTask" modelAttribute="recruitFile">
			...
			<c:if test="${recruitFile.isPrejudication == false}">
				<div class="blank10"></div>
				<input value="two"  type="hidden" id="envelopeType" name="envelopeType">
			...
			<div class="blank10"></div>
				<input id="save" type="button" class="button red" value="保 存" />
				<input id='complete' type="button" class="button red" value="下一步" />
