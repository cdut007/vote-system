		...
		<tr>
			...
			<td>
					<select name="FWSZ_BMK_3_DOWN_RATIO" id="FWSZ_BMK_3_DOWN_RATIO" onchange="updateFWSZBenchmar('FWSZ_BMK_3');" >
						<option value="${data.FWSZ_BMK_3_DOWN_RATIO }" selected >${data.FWSZ_BMK_3_DOWN_RATIO }%</option>
					</select>	
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
					<select name="FWSZ_BMK_2_DOWN_RATIO" id="FWSZ_BMK_2_DOWN_RATIO" onchange="updateFWSZBenchmar('FWSZ_BMK_2');">
						<option value="${data.FWSZ_BMK_2_DOWN_RATIO }" selected >${data.FWSZ_BMK_2_DOWN_RATIO }%</option>
					</select>	
			</td>
		</tr>
		<tr>
			...
			<td>
				<select name="FWSZ_BMK_2_CONTROL_PRICE_RIGHT" id="FWSZ_BMK_2_CONTROL_PRICE_RIGHT">
					<option value="${data.FWSZ_BMK_2_CONTROL_PRICE_RIGHT }" selected >${data.FWSZ_BMK_2_CONTROL_PRICE_RIGHT }%</option>
				</select>
			</td>
		</tr>
		<tr>
			...
			<td>
				<select name="FWSZ_BMK_2_AVG_PRICE_RIGHT" id="FWSZ_BMK_2_AVG_PRICE_RIGHT" disabled="disabled">
					<option value="${data.FWSZ_BMK_2_AVG_PRICE_RIGHT }" selected >${data.FWSZ_BMK_2_AVG_PRICE_RIGHT }%</option>
				</select>
			</td>
		</tr>
		<tr>
...
$(function(){
	if("${data.benchmarkInstance.benchmarkName}"=="评标基准价2(房建)"){
		$("#FWSZ_BMK_2").show();
