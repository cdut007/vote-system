	...
	<div class="block">
		<form:form id="zbwjForm" method="post" action="${pageContext.request.contextPath}/flow/completeTask" modelAttribute="recruitFile">
					...
					<table width="98%" style="table-layout:fixed;margin:0 auto;">
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" id="inviteEndTime" value="<fmt:formatDate value="${invitation.inviteEndTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss" timeStyle="default" />" onfocus="" data-options="required:true" name="invitation.inviteEndTime" class="inputxt Wdate easyui-validatebox" missingMessage="请选择开标时间！" />
								</td>
							</tr>
						</tbody>
					</table>
				...
				<table width="98%" style="table-layout:fixed;margin:0 auto;">
					<tbody>
						...
						<tr>
							...
							<td>评标基准价</td>
							<td>
								<select id="evaluationMethodId" name="recruitFileData.benchmarkId">
								</select>
							</td>
						</tr>
						<tr>
						...
						<tr style="display:none;" id='floatRate_tr'>
							<td class="need">*</td>
							<td style="width:100px">向下浮动比率
							</td>
							<td>
								<input id="floatRate" path="floatRate"  readonly="readonly" />&nbsp;%
							</td>
						</tr>
						<tr style="display:none;" id='CMPRate_tr'>
							<td class="need">*</td>
							<td style="width:100px">施工组织设计最低分比例(60~80%)：
							<input type="hidden" id="isUsed" value="1" />
							</td>
							<td>
								<input id="CMPRate" path="CMPRate"  readonly="readonly" />&nbsp;%
							</td>
						</tr>
						<tr id='cbps'>
						</tr>
			...
			<c:if test="${recruitFile.reviewStatus=='19' || recruitFile.reviewStatus=='0' || recruitFile.reviewStatus=='2' || recruitFile.reviewStatus=='3' || recruitFile.reviewStatus=='4' || recruitFile.reviewStatus=='91'}">
				...
				<input id='complete' type="button" class="button red" value="提交审核" disabled />
			</c:if>
