...
<c:set value="${invitationFileService.pagingInvitationFileTenderData(invitationFile.id)}" var="tenderlist" scope="request"></c:set>
...
<body>
	...
	<div class="block">
			...
			<input type="hidden" name="nopassReason" id="nopassReason" value="" />
