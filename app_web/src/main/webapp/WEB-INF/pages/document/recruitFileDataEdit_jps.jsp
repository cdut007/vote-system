...
<script type="text/javascript" src="/resources/page/document/recruitFileDataEdit1.js"></script>
<style type="text/css">
#bigJE {
	color: #f00;
	font-size: 14px;
				...
				<table width="98%" style="table-layout:fixed;margin:0 auto;">
					<tbody>
						<tr>
							...
							<td>
								<input type="hidden" id="recruitFileData_evaluationMethodId" value="4028e300-624113f1-0162-4113f175-0000" name="recruitFileData.evaluationMethodId"/>
								<input type="hidden" id="recruitFileData_benchmarkId" value="4028e300-624113f1-0162-4113f175-0000" name="recruitFileData.benchmarkId"/>
								<select id="evaluationType">
									<option value="" label="经评审的最低价投标法(房建)"/>
								</select>
							</td>
						</tr>
						<tr id="cbps">
