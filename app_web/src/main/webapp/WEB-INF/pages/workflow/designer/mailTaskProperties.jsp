		...
		<div id="task-properties-accordion" class="easyui-accordion" fit="true" border="false">
			...
			<div id="mainConfig" title="主配置" class="properties-menu">
				<table id="main-properties">
					<tr>
						<td align="right" style="width:80px">接收人:</td>
						<td>
					...
					<tr>
						...
						<td>
							<textarea id="htmlText" name="htmlText" rows="5"></textarea>
						</td>
					</tr>
					<tr>
						<td align="right">Non-Html Text:</td>
						<td>
							<textarea id="nonhtmlText" name="nonhtmlText" rows="5"></textarea>
						</td>
					</tr>
				</table>
			</div>
