...
<!--
		...
		jq('#process-listeners-list').datagrid({
			...
			toolbar : [ {
				...
				handler : function() {
					...
					//_listener_frame.src="";
					_listener_win.window('refresh', '${pageContext.request.contextPath}/workflow/designer/processListenerConfig?t=' + new Date().getTime());
	...
	function listenerActionBt(value, rowData, rowIndex) {
		var id = rowData.id;
		var e = '<img onclick="editListener(\'' + id + '\')" src="/resources/designer/image/edit.gif" title="' + "修改" + '" style="cursor:hand;"/>';
	...
	function processVariablesActionFormatter(value, rowData, rowIndex) {
		...
		var s = '<img onclick="saveProcessVariable(' + id + ')" src="/resources/designer/image/ok.png" title="' + "确定" + '" style="cursor:hand;"/>';
		var c = '<img onclick="cancelProcessVariable(' + id + ')" src="/resources/designer/image/cancel.png" title="' + "取消" + '" style="cursor:hand;"/>';
		var e = '<img onclick="editProcessVariable(' + id + ')" src="/resources/designer/image/modify.png" title="' + "修改" + '" style="cursor:hand;"/>';
		var d = '<img onclick="deleteProcessVariable(' + id + ')" src="/resources/designer/image/delete.gif" title="' + "删除" + '" style="cursor:hand;"/>';
		if (rowData.editing)
			return s;
		else
			return e + '&nbsp;' + d;
...
<div id="process-properties-layout" class="easyui-layout" fit="true">
	...
	<div id="process-properties-panel" region="center" border="true">
		<div class="easyui-accordion" fit="true" border="false">
			...
			<div id="variables" title="流程变量配置" class="properties-menu">
