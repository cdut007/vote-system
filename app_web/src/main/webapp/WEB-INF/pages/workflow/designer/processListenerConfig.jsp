...
<!--
	...
	function listenerFieldsActionFormatter(value, rowData, rowIndex) {
		var id = rowIndex;
		var s = '<img onclick="saveListenerField(' + id + ')" src="${pageContext.request.contextPath}/image/ok.png" title="' + "ç¡®å®" + '" style="cursor:hand;"/>';
		var c = '<img onclick="cancelListenerField(' + id + ')" src="${pageContext.request.contextPath}/image/cancel.png" title="' + "åæ¶" + '" style="cursor:hand;"/>';
		var e = '<img onclick="editListenerField(' + id + ')" src="${pageContext.request.contextPath}/image/modify.png" title="' + "ä¿®æ¹" + '" style="cursor:hand;"/>';
		var d = '<img onclick="deleteListenerField(' + id + ')" src="${pageContext.request.contextPath}/image/delete.gif" title="' + "å é¤" + '" style="cursor:hand;"/>';
		if (rowData.editing)
			return s;
		else
			return e + '&nbsp;' + d;
...
<table>
	...
	<tr>
		<td></td>
		<td align="left">
			<input type="radio" id="listenerServiceType" name="listenerServiceType" value="javaClass" checked="checked" onclick="changeListenerServiceType(this)">Java Class <input type="radio" id="listenerServiceType" name="listenerServiceType" value="expression" onclick="changeListenerServiceType(this)">Express
		</td>
	</tr>
	<tr>
		<td id="listenerServiceLabel" align="right">Service Class:</td>
		<td>
			<input type="text" id="listenerServiceClass" name="listenerServiceClass" size="80" value="" readonly="readonly" /> <input type="text" id="listenerServiceExpression" name="listenerServiceExpression" size="80" style="display: none;" value="" /> <a href="##" id="selectListenerServiceClassBt" onclick="">Select</a>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2" align="center">
			<a href="##" id="fieldSaveBt" onclick="saveListenerConfig()">保存</a> <a href="##" id="fieldCancelBt" onclick="closeProcessListenerWin()">Cancel</a>
		</td>
	</tr>
</table>