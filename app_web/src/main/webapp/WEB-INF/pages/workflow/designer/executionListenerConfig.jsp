...
<table>
	...
	<tr>
		...
		<td>
			<input type="text" id="listenerServiceClass" name="listenerServiceClass" size="80" value="" /> <input type="text" id="listenerServiceExpression" name="listenerServiceExpression" size="80" style="display: none;" value="" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2" align="center">
			<a href="##" id="fieldSaveBt" onclick="saveListenerConfig()">保存</a> <a href="##" id="fieldCancelBt" onclick="closeTaskListenerWin()">Cancel</a>
		</td>
	</tr>
</table>
