...
<!--
	...
	function listenerFieldsActionFormatter(value, rowData, rowIndex) {
		var id = rowIndex;
		var s = '<img onclick="saveListenerField(' + id + ')" src="/resources/designer/image/ok.png" title="' + "确定" + '" style="cursor:hand;"/>';
		var c = '<img onclick="cancelListenerField(' + id + ')" src="/resources/designer/image/cancel.png" title="' + "取消" + '" style="cursor:hand;"/>';
		var e = '<img onclick="editListenerField(' + id + ')" src="/resources/designer/image/modify.png" title="' + "修改" + '" style="cursor:hand;"/>';
		var d = '<img onclick="deleteListenerField(' + id + ')" src="/resources/designer/image/delete.gif" title="' + "删除" + '" style="cursor:hand;"/>';
		if (rowData.editing)
			return s;
		else
			return e + '&nbsp;' + d;
...
<table>
	...
	<tr>
		<td colspan="2" align="center">
			<a href="##" id="fieldSaveBt" onclick="saveListenerConfig()">保存</a> <a href="##" id="fieldCancelBt" onclick="closeLineListenerWin()">Cancel</a>
		</td>
	</tr>
</table>