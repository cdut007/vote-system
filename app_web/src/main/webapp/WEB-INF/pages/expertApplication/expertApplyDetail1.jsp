...
<body>
	...
	<div class="block">
		<form:form id="registerForm" class="registerForm" method="post" modelAttribute="expertApply" action="${pageContext.request.contextPath}/workflow/completeForm">
			...
			<input id='complete' type="button" class="button red" value="提交" />
		</form:form>
		<script>
