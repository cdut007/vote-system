...
$(function() {
	$("#project_list").datagrid({
		...
		pagination : true,
		title:"项目列表",
		url : "${pageContext.request.contextPath}/project/list_a",
		idField : "id",
		...
		toolbar : [
				{
					...
					handler : function() {
						window.location.href="/project/view_create_a_project"
					}
				}
				],
			columns : [ [ {
			...
			{field:"id",title:"操作",align:"center",width:120,formatter : function(value,row,index) {
				...
				returnValue+='<a class="button red small" href="'+ctx+'/project/view_create_a_project?id=' +row["id"] + '">编辑</a>';
