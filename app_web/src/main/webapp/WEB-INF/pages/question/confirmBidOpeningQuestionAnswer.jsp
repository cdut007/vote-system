...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#sub").click(function() {
			...
			if(r==1){
				var paramsArray = {"bidOpeningQuestion":"${bidOpeningQuestion}", "id":"${bidOpeningQuestion.id}"};
                var returnValue = SaveDocArray(paramsArray,"${pageScope.basePath}/question/bidOpeningQuestionAnswerSign");
                if ("OK" == returnValue) {
                    ShowMessage("文件上传成功");
