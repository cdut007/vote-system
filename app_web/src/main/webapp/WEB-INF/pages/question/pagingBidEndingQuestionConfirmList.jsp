...
<script type="text/javascript">
	...
	function chengQing(bidEndingQuestionId) {
		window.open(ctx+"/question/bidEndingQuestionAnswerView?bidEndingQuestionId="+bidEndingQuestionId);
	}
	...
	function sectionList() {
		$("#bidEndingQuestionConfirm-datagrid").datagrid({
			singleSelect : true,
			rownumbers : true,
			fitColumns : true,
			striped : true,
			...
			title : "评标结果澄清文件列表",
			region : "center",
			url : ctx + "/question/pagingBidEndingQuestionConfirmData",
			idField : "id",
			columns : [ [ {
				field : "organTName",
				title : "招标单位",
...
<body>
	...
	<div class="block ">
		...
		<div class="AreaR">
			...
			<div class="block">
				<table id="bidEndingQuestionConfirm-datagrid" class="easyui-datagird"></table>
			</div>
		</div>
	</div>
	<div class="blank10"></div>
