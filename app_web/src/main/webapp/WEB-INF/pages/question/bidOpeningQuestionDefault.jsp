...
<p style="text-align: center;">
	<strong><span style="font-family: 宋体; font-size: 20px;">${bidOpeningQuestion.organAName}</span></strong>
</p>
<p style="height: 10px;"></p>
<p style="text-align: center;">
	<strong><span style="font-family: 宋体; font-size: 20px;">${bidOpeningQuestion.projectInstanceName}答疑文件</span></strong>
</p>
<p style="line-height: 33px;">
	<span style="font-family: 宋体; font-size: 16px;">投标单位：</span>
	<span style="font-size: 16px;text-decoration: underline;">&nbsp;${bidOpeningQuestion.organBName }&nbsp;</span>
</p>
...
<p style="line-height: 32px; text-indent: 32px;">
	...
	<strong><span style="text-decoration: underline;">${bidOpeningQuestion.projectInstance.zbxmbh}</span></strong>
	的
	<strong><span style="text-decoration: underline;">${bidOpeningQuestion.projectInstance.zbxmmc}</span></strong>答疑文件，内容如下：
	</span>
</p>
<p style="line-height: 33px;">
</p>
...
<p style="line-height: 150%; text-indent: 450px;">
	<span style="line-height: 150%; font-family: 宋体; font-size: 16px;">${bidOpeningQuestion.organAName}</span>
</p>
<p style="line-height: 150%;text-indent: 450px;">
