...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#sub").click(function() {
			...
			if(r==1){
                var paramsArray = {"receipt":"${receipt}", "id":"${receipt.id}"};
                var returnValue = SaveDocArray(paramsArray,"${pageScope.basePath}/question/confirmQuestionSign");
                if ("OK" == returnValue) {
                    ShowMessage("文件上传成功");
	...
	function HWPostil1_NotifyCtrlReady() {
        ...
        OpenFile("${pageScope.basePath}/attachment/download/${receipt.pdfAttachment.fjid00}");
	...
	<div class="block">
		...
		<div class="usBox main" style="padding: 3px;height:660px;" id="ht_content">
			...
			<span style="float:right"> 
				...
				<a class="button red" id='sub'>提交回执</a>
			</span>
		</div>
	</div>
</body>
