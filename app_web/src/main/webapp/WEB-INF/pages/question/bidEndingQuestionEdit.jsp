...
<form:form modelAttribute="bidEndingQuestion" action="${pageContext.request.contextPath}/question/saveOrUpdateBidEndingQuestion">
	<form:hidden path="candidatePublicityId" />
	<table>
		<tr>
			<td>招标单位：</td>
			<td>${candidatePublicity.projectInstance.organTName}</td>
		</tr>
		<tr>
			<td>招标项目：</td>
			<td>${candidatePublicity.projectInstance.zbxmmc}</td>
		</tr>
		<%-- <tr>
			<td>标段(包)集合：</td>
			<td>
		...
		<tr>
			<td>公告发布时间：</td>
			<td>${candidatePublicity.gskssj}</td>
		</tr>
		<tr>
			<td>问题内容：</td>
			<td>
