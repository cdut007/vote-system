...
<script type="text/javascript">
	...
	function chengQing(bidOpeningQuestionId) {
		window.open(ctx+"/question/bidOpeningQuestionAnswerView?bidOpeningQuestionId="+bidOpeningQuestionId);
	}
	...
	function sectionList() {
		$("#bidOpeningQuestionConfirm-datagrid").datagrid({
			singleSelect : true,
			rownumbers : true,
			fitColumns : true,
			striped : true,
			...
			title : "开标过程澄清文件列表",
			region : "center",
			url : ctx + "/question/pagingBidOpeningQuestionConfirmData",
			idField : "id",
			columns : [ [ {
				field : "organTName",
				title : "招标单位",
...
<body>
	...
	<div class="block ">
		...
		<div class="AreaR">
			...
			<div class="block">
				<table id="bidOpeningQuestionConfirm-datagrid" class="easyui-datagird"></table>
			</div>
		</div>
	</div>
	<div class="blank10"></div>
