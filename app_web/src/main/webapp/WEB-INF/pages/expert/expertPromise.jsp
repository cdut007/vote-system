...
<c:catch var="exception">
	<c:set value="${expertApplyId}" var="expertApplyId"></c:set>
	<c:set value="${expertService.judgeExpert(expertApplyId)}" var="flag"></c:set>
</c:catch>
...
<script type="text/javascript" src="/resources/aip/AipMain.js"></script>
	...
	<script type="text/javascript">
		function HWPostil1_NotifyCtrlReady() {
		    ...
		    OpenFile("${pageScope.basePath}/attachment/download/${expertPromise.pdfAttachment.fjid00}");
		...
		$(function(){
			...
			var expertApplyId = "${expertApplyId}";
			...
			$("#pass").click(function() {
	            ...
	            //m.set("taskId","${taskId}"); 
	            //var returnValue = SaveDoc(m,"${pageScope.basePath}/expertPromise/expertPromiseSave");
