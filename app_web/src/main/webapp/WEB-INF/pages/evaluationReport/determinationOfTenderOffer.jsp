...
<c:set value="${expertApplyService.getExpertSealSignList(processBusinessKey,'','DECIDE_PRICE')}" var="expertSignList" />
<%
	...
	$(function() {
		...
		$("#submitBtn").click(function(){
			...
			if(r==1){
                ...
                var paramsArray = {"taskId":"${taskId}","projectItemId":"${projectItem.id}","agree":"true"};
