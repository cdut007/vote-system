...
document.write('codebase="/resources/weboffice/OfficeControl.cab#version=5,0,3,0" width="100%" height=768>   ');
...
document.write('<param name="WebUserName" value="JINCHAN">   ');
document.write('<param name="Caption" value="JINCHAN 金蝉电子招标系统 http://www.jinchan.com">   ');
document.write('<SPAN STYLE="color:red">不能装载文档控件。请确认你可以连接网络或者检查浏览器的选项中安全设置。</SPAN>');
